          ...
          <Row>
            <Col lg='6'>
              <div className="hero__content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Enim ducimus vero rem quasi vel expedita voluptate ipsum sunt, sed cum commodi adipisci tempore amet odit aliquid quos eligendi nobis sapiente?</p>
              </div>
            </Col>
            <Col lg='2'>
          ...
          <Row>
            <Col lg='6'>
              <div className="experience__content">
                <Subtitle subtitle={"Experince"}></Subtitle>
                <h2>
                  With our all experience <br /> we will serve you
                </h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />
                  quaerat officia corporis voluptatem quas nis doloremque!
                </p>
              </div>
